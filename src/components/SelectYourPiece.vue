<template>
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h3 class='text-center'>Help contribute to Tamara's campaign by sponsoring a piece of the puzzle.</h3>
      </div>
    </div>

    <div class="row">
      <div class="col-lg-12">
        <h4 class='text-center'>Make a difference by selecting the amount below that you would like to donate.</h4>
      </div>
    </div>

    <div class="row">
      <div class="col-lg-12">
        <h4 class='text-center'>Green are available. Gray are taken.</h4>
      </div>
    </div>
